      ...
      <div className="min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        <div className="h-96 flex flex-col lg:flex-row-reverse gap-4">
          ...
          <div className="h-full">
            {loading ? (
              <div className="flex gap-2 lg:flex-col overflow-x-auto scrollbar-none h-full">
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 my-2">
              <button
                className="border-2 border-red-600 rounded px-3 py-1 min-w-[120px] text-red-600 font-medium hover:bg-orange-600 hover:text-white"
                onClick={(e) => handleBuyProduct(e, data._id)}
              >
                Buy
              </button>
              <button
                className="border-2 border-red-600 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-orange-600 hover:text-red-600 hover:bg-white"
